...
function ft_settings_external_load() {
  ...
  //define("USERNAME", "root"); // Your default username.
  //define("PASSWORD", "slack142"); // Your default password.
  ...
  $ft["settings"]["MAXSIZE"]           = 200000000; // Maximum file upload size - in bytes.
  ...
  $ft["settings"]["FILETYPEWHITELIST"] = "pdf doc xls docx xlsx csv odt tar gz zip rar jpg jpeg bmp png txt"; // Add file types here to *only* allow those types to be uploaded.
  ...
  $ft["plugins"]["edit"] = array(
   "settings" => array(
     "editlist" => "txt html htm css odt doc",
     "converttabs" => FALSE
   )
  );
  ...
  $ft['groups']['admin'] = array(
    'DIR' => '/'
       
  );
  
  $ft['groups']['develop'] = array(
    'DIR' => '/mnt/sda5/'
